      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage user profiles and their uploaded media</p>
          </div>
        </div>
        <Card>
          <CardHeader>
        ...
        {users.length === 0 ? (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Get started by creating your first user profile</CardDescription>
            </CardHeader>
            <CardContent>
